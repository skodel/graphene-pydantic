...
def test_convert_optional_annotated_type():
    spec = T.Annotated[str, pydantic.StringConstraints(min_length=2, max_length=256)]
    # _convert_field_from_spec("attr", (spec, "test"))
